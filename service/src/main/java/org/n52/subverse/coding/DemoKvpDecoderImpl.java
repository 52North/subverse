...
import static org.n52.subverse.coding.KvpDecoder.createKey;
import org.n52.subverse.request.DemoRequest;
import org.n52.iceland.util.KvpHelper;
import org.n52.subverse.SubverseConstants;

public class DemoKvpDecoderImpl extends KvpDecoder<DemoRequest> {

    private static final Set<DecoderKey> KEYS = Collections.unmodifiableSet(Sets.newHashSet(createKey(SubverseConstants.SERVICE, SubverseConstants.VERSION, SubverseConstants.OPERATION_DEMO)));

    @Override
    protected DemoRequest createRequest() {
        return new DemoRequest(SubverseConstants.VERSION);
    }
    ...
    protected void decodeParameter(DemoRequest request, String name, String values) throws OwsExceptionReport {
        switch (name.toLowerCase()) {
            case SubverseConstants.OperationParameter.service:
                ...
                break;
            case SubverseConstants.OperationParameter.version:
            ...
            case SubverseConstants.OperationParameter.request:
                ...
                break;
            case SubverseConstants.DemoParameter.one:
                request.setOne(KvpHelper.checkParameterSingleValue(values, name));
                break;
            case SubverseConstants.DemoParameter.two:
