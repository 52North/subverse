 ...
 */
public class FixmMqttConsumerFactory implements Constructable, Destroyable, PublicationsProvider {

    private static final Logger LOG = LoggerFactory.getLogger(FixmMqttConsumerFactory.class);
    private PahoMqttConsumer consumer;
    private FilterEngine engine;
    protected static final String IDENTIFIER = "FIXM";
